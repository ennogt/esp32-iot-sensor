...
1. Device creates a **SoftAP hotspot** named `PROV_ESP32_SENSOR` (configurable)
2. Use the **ESP SoftAP Prov** app (available for iOS/Android) to provision:
   - Connect to the hotspot in the app
   - Select your WiFi network and enter password
3. Device connects and boots normally on subsequent restarts

**Reset WiFi credentials:**
Hold the button (GPIO 4) during boot/power-on to erase stored WiFi credentials and restart provisioning mode.
